# Next.js 16 (Beta) Starter (tailwind) [[LIVE DEMO](https://nextjs-16-starter-tailwind.vercel.app/)]
...
*This is the Tailwind version for Next.js 16 (Beta) Starter, you may be interested in other templates too -*
- [**Next.js 16 (Beta) Starter Core**](https://github.com/SiddharthaMaity/nextjs-16-starter-core)
- [**Next.js 16 (Beta) Starter with Shadcn UI**](https://github.com/SiddharthaMaity/nextjs-16-starter-shadcn)

Welcome to the **Next.js 16 (Beta) Starter** repository! This starter template is built with Next.js 16 (Beta), React 19, TypeScript 5, Tailwind CSS 4 and comes packed with several powerful tools and configurations to accelerate your project setup and streamline development workflows using VS Code.
